  ...
  <div class="container-fluid">
    <div>
      ...
      >
        ...
        >
          <div
            class="restaurant-overlay d-flex align-items-center justify-content-center"
          >
    ...
    >
      <div v-for="dish in filteredDishes" :key="dish.id" class="col-md-4 mb-4">
        <div class="dish-card align-items-center">
          ...
          >
            <p
              class="fs-4 dish-title-description p-2 rounded-2 align-items-center p-0"
            >
              {{ dish.name }}
            </p>
        ...
        <!--Card bottom-->
        <div
          class="d-flex gap-2 mt-2 justify-content-center align-items-center"
        >
          <div>
            <span
              v-if="dish.visible"
            ...
            >
              ...
              <button type="button" class="badge add-to-cart-button">
                <span
                  ><i class="bi bi-cart-plus fs-5"></i>{{ dish.price }} €</span
                >
              </button>
            </span>
