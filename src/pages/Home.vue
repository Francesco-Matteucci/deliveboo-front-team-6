  ...
  <div>
    ...
    <div class="container-fluid pt-5">
      <div v-if="categories.length" class="categories-container text-center mb-4">
        ...
        <div class="categories-list d-flex flex-wrap justify-content-center w-75">
          ...
          <button @click="
            selectedCategories = [];
          filterRestaurants();
          " class="btn btn-outline-primary mx-1 mb-1" :class="{ active: selectedCategories.length === 0 }">
            Tutte le Categorie
          </button>
        </div>
        <!-- barra di ricerca -->
      ...
      <div v-if="!loading && !error" class="row px-5">
        <div v-for="restaurant in filteredRestaurants" :key="restaurant.id" class="col-lg-2 col-md-6 md-2 g-4">
